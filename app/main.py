...
from app.deleteimgs import deleteImages
deleteImages()
...
if per_white > 10:
	...
	img_lst.append(('color_change',img))
...
img_lst.append(('means_shift_image',img))
...
img_lst.append(('Contour',neworiginal))
...
img_lst.append(('ROI',frame))
img_lst.append(('rectangle_ROIr',roi))
img = roi
...
img_lst.append(('masked_out_img',mask))
...
for x in range(len(contours)):
	...
	img_lst.append(('Contour_masked',originalroi))
...
for name , img in img_lst:
	cv2.imwrite('./tests/'+name+'.jpg', img) 
